...
from .test_mixins import TailBBoxTestMixin, MaskTestMixin


@HEADS.register_module()
class TailRoIHead(BaseRoIHead, TailBBoxTestMixin, MaskTestMixin):
    ...
    def forward_train(self,
        ...
        if self.with_bbox:
            ...
            # print(bbox_results.keys(), bbox_results_tail.keys())
    ...
    def _bbox_forward_train(self, x, sampling_results, sampling_results_tail, gt_bboxes, gt_labels, img_metas):
